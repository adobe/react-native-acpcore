...
import ACPCore from "../ts/ACPCore";
import { ACPExtensionEvent } from "../ts/models/ACPExtensionEvent";
import { ACPMobileLogLevel } from "../ts/models/ACPMobileLogLevel";
import { ACPMobilePrivacyStatus } from "../ts/models/ACPMobilePrivacyStatus";
...
describe("ACPCore", () => {
  ...
  test("setLogLevel is called with correct parameters", async () => {
    ...
    let logLevel = ACPMobileLogLevel.ACP_LOG_LEVEL_DEBUG;
  ...
  test("setPrivacyStatus is called with correct parameters", async () => {
    ...
    let privacyStatus = ACPMobilePrivacyStatus.ACP_PRIVACY_STATUS_UNKNOWN;
  ...
  test("dispatchEvent is called with correct parameters", async () => {
    ...
    let testEvent = new ACPExtensionEvent(
      "eventName",
      "eventType",
      "eventSource",
  ...
  test("dispatchResponseEvent is called with correct parameters", async () => {
    ...
    let testEvent1 = new ACPExtensionEvent(
      "eventName1",
      "eventType1",
      "eventSource1",
