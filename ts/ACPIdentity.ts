...
import { ACPVisitorID } from "./models/ACPVisitorID";
import { NativeModules } from "react-native";
import { ACPMobileVisitorAuthenticationState } from "./models/ACPMobileVisitorAuthenticationState";

interface IACPIdentity {
  extensionVersion: () => Promise<string>;
  syncIdentifiers: (identifiers?: { [key: string]: string }) => void;
...
const RCTACPIdentity: IACPIdentity = NativeModules.ACPIdentity;

const ACPIdentity: IACPIdentity = {
  /**
   ...
   */
  syncIdentifiers(identifiers?: { [key: string]: string }) {
  ...
  syncIdentifiersWithAuthState(
    ...
    RCTACPIdentity.syncIdentifiersWithAuthState(
      identifiers,
      authenticationState
    );
  },
